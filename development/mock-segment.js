 ...
 * any)
 *
 * This can be used with the BlockStar extension by setting the `SEGMENT_HOST` environment
 * variable or config entry when building BlockStar.
 *
 * For example, to build BlockStar for use with this mock Segment server, you could set the
