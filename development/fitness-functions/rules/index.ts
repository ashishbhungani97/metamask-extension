...
const RULES: IRule[] = [
  {
    ...
    errorMessage:
      '`sinon` or `assert` was detected in the diff. Please use Jest instead. For more info: https://github.com/BlockStar/metamask-extension/blob/develop/docs/testing.md#favor-jest-instead-of-mocha',
  },
  {
