...
[BlockStar Design System Guides](https://www.notion.so/BlockStar-Design-System-Guides-Design-f86ecc914d6b4eb6873a122b83c12940)
...
The `Typography` component has been deprecated in favor of the `Text` component. You can contribute by submitting a PR against [Replace deprecated Typography with Text component](https://github.com/BlockStar/metamask-extension/issues/17670) on GitHub. Below are code examples converting from `Typography` to `Text`.
