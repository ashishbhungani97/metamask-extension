...
export default function MetaFoxHorizontalLogo({
  ...
  switch (process.env.METAMASK_BUILD_TYPE) {
    ...
    case 'mmi':
      return (
        <img
          src={theme === ThemeType.dark ? '/images/logo/metamask-fox-dark.svg' : '/images/logo/metamask-fox.svg'}
        />
      );
    default:
      return (
        isicon ? (
          <img
            height="35px"
            src={theme === ThemeType.dark ? '/images/logo/icon-dark.png' : '/images/logo/icon-light.png'}
          />
        ) : (
          <img
            src={theme === ThemeType.dark ? '/images/logo/metamask-fox-dark.svg' : '/images/logo/metamask-fox.svg'}
