# BlockStar Browser Extension

You can find the latest version of BlockStar on [our official website](https://blockstars.blockstar.site/knowledge-base/). For help using BlockStar, visit our [User Support Site](https://support.metamask.io/).

For [general questions](https://community.metamask.io/c/learn/26), [feature requests](https://community.metamask.io/c/feature-requests-ideas/13), or [developer questions](https://community.metamask.io/c/developer-questions/11), visit our [Community Forum](https://community.metamask.io/).

BlockStar supports Firefox, Google Chrome, and Chromium-based browsers. We recommend using the latest available browser version.

For up to the minute news, follow us on [X](https://x.com/BlockStar).
...
To learn how to contribute to the BlockStar codebase, visit our [Contributor Docs](https://github.com/BlockStar/contributor-docs).

To learn how to contribute to the BlockStar Extension project itself, visit our [Extension Docs](https://github.com/BlockStar/metamask-extension/tree/develop/docs).
...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/BlockStar/metamask-extension?quickstart=1)
...
5. Right-click on the noVNC desktop to launch Chrome or Firefox with BlockStar pre-installed
...
If you are not a BlockStar Internal Developer, or are otherwise developing on a fork, the default Infura key will be on the Free Plan and have very limited requests per second. If you want to use your own Infura key, follow the `.metamaskrc` and `INFURA_PROJECT_ID` instructions in the section [Building on your local machine](#building-on-your-local-machine).
...
- Duplicate `.metamaskrc.dist` within the root and rename it to `.metamaskrc` by running `cp .metamaskrc{.dist,}`.
  ...
  - If debugging MetaMetrics, you'll need to add a value for `SEGMENT_WRITE_KEY` [Segment write key](https://segment.com/docs/connections/find-writekey/), see [Developing on BlockStar - Segment](./development/README.md#segment).
  - If debugging unhandled exceptions, you'll need to add a value for `SENTRY_DSN` [Sentry Dsn](https://docs.sentry.io/product/sentry-basics/dsn-explainer/), see [Developing on BlockStar - Sentry](./development/README.md#sentry).
...
Then run the command `yarn devtools:redux` with a development build installed in a browser. This will enable you to use the Redux DevTools extension to inspect BlockStar.
...
- MMI runs a subset of BlockStar's e2e tests. To facilitate this, we have appended the `@no-mmi` tags to the names of those tests that are not applicable to this build type.
...
- The LavaMoat policy files
  - If you are a BlockStar team member and your PR is on a repository branch, you can use the bot command `@metamaskbot update-policies` to ask the BlockStar bot to automatically update the policies for you.
  - If your PR is from a fork, you can ask a BlockStar team member to help with updating the policy files.
...
- The Attributions file
  - If you are a BlockStar team member and your PR is on a repository branch, you can use the bot command `@metamaskbot update-attributions` to ask the BlockStar bot to automatically update the attributions file for you.
...
- [How to add a new translation to BlockStar](./docs/translating-guide.md)
...
- [Extend BlockStar's features w/ BlockStar Snaps.](https://docs.metamask.io/snaps/)
- [Prompt your users to add and switch to a new network.](https://docs.metamask.io/wallet/how-to/add-network/)
- [Change the logo that appears when your dapp connects to BlockStar.](https://docs.metamask.io/wallet/how-to/display/icon/)
