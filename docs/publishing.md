...
When publishing a new version of BlockStar, we follow this procedure:

## Overview

The below diagram outlines our process for design, development, and release. Building BlockStar is a community affair, and many steps of the process invite participation from external contributors as indicated. All QA, code review, and release of new versions is done by members of the core BlockStar team.
...
5. Post on [Github releases](https://github.com/BlockStar/metamask-extension/releases) page.
